...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
                                    <li class=""><a href="phome.html">Home</a></li>
					<li class=""><a href="psetting">Product Settings</a></li>
					<li class="dropdown"><a href="lholders">License holders </a></li>
					<li class="active"><a href="#">trial version users</a></li>
    ...
    <tr class="table-bordered">
        <td>vcvxcxvc</td>
        <td>cvxvcxvcx</td>
        <td>cxg/f/m.,ghl;.,gl;fhml;fgml;fgh,;lfgh</td>
        <td>cxv</td>
