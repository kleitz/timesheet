...
<body>
  ...
  <!-- container -->
  <div class="container" style="text-decoration-color: black; height:450px; width:100%; position: relative;">
...
{{ Form::model($licennse, array('method' => 'PUT', 'route' => array('licennses.update', $licennse->id),'files'=>true, 'id' =>'frmSimpleEventData'))}}
