...
<table class="table" style="max-width:90%; padding: 20%; alignment-adjust: central; border-style: inset;
   ...
   <tr style= "background-color: grey; color: white"><td>
    <h4>Enter Your Progress </h4>        
           ...
           @foreach($tsmanagements as $tm)
             
     <tr>
    <th>Submission Date</th>
    <td > 
           <input class="form-control" type="date" name="submition_date" value="{{$tm->submition_date}}" >
    ...
    <th>Review Date</th>
    <td > 
           <input class="form-control" type="date" name="review_deadline" value="{{$tm->review_deadline}}">
    ...
    <th>Created By</th>
    <td > 
           <input class="form-control" type="date" name="created_by" value="{{$tm->created_by}}">
