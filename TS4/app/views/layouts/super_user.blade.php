		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li><a href="#">Build Organization</a></li>
...
<button href="{{route('newHierarchy')}}" type="submit" value="Add new Level To Hierarchy" class="btn btn-default">Add New Level</button>
...
<!---------------------------- HERE IS THE DYNAMICALLY GENERATING SET HIERARCHY TABLE ---------------------->
