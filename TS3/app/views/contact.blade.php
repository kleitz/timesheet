...
<head>
	...
	<title>Contact us - Timesheet</title>
...
<!--					We’d love to hear from you. Interested in working together? Fill out the form below with some info about your project and I will get back to you as soon as I can. Please allow a couple days for me to respond.-->
				Please Leave Your Questions and Queries Related To to Product for better provision of Service
                                </p>
				<br>
					<form>
						<div class="row">
			...
			<aside class="col-sm-3 sidebar sidebar-right">
				...
				<div class="widget">
					<h4>Address</h4>
					<address>
						54-Lawrence Road, Lahore, Punjab, Pakistan.
					</address>
					<h4>Phone:</h4>
					<address>
						(713) 791-1414
