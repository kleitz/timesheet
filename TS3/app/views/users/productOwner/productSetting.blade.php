...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="licenseHolder">License holders </a></li>
					<li class="dropdown"><a href="trialUsers">trial version users</a></li>
					<!--<li><a href="accepted">Accepted Timesheets</a></li>-->
	...
	<!-- container -->
	<div class="container" style="text-decoration-color: black; position: relative; height:450px; width:100%;">
...
<table class="table" style="max-width:90%; alignment-adjust: central; border-style: inset; border-width: 4px; border-color: darkgrey; margin-top: 5%; margin-left: 5%;">
           ...
           <tbody>
              ...
              <tr>
                <td>Set trial period</td>
                <td> <input class="form-control" type="text" name="tperiod" placeholder="Months"> </td>
              </tr>
              

              <tr >
                <td >Set price of the package</td>
                <td><div ><input class="form-control"  type="text" name="ppackage" placeholder="Rs"></div></td>
              </tr>
              

              <tr>
                <td >Expiry notification before </td>
                <td > <input class="form-control" type="text" name="enotification" placeholder="Days"></td>
              </tr>
               ...
               <tr>
                    ...
                    <td>
                    <input class="form-control" type="Button" name="saveps" value="Save" style="max-width: 20%; margin-left: auto;">
                    </td>
               </tr>
