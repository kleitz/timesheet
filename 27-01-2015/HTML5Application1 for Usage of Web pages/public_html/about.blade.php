...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="about.html">About The Product</a></li>
					<li class="dropdown">
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.html">Home</a></li>
			<li class="active">About The Product</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">About The Product</h1>
				</header>
				<h3>What is it?</h3>
				<p><img src="assets/images/mac.jpg" alt="" class="img-rounded pull-right" width="300" > It is the system developed for building the harmony and coordination between Employers and Employees. This product is used to make the reporting mechanism fast and efficient.  Performance of Employees is monitored easily with the help of Timesheet. It makes the organizational system fast and quick responding. Time delays in the reporting procedure are minimized with the help of Timesheet. </p>
				<p></p>
				<h3>What it does?</h3>
				<p>This product provides the services related to coordination between the Employer and Employees. It provides the interface for reporting and reviewing the activity forms filled by the Employees. It works just like an organization based on the report and review system of Employee's performance. Being an electronic system it decreases the time consumed in searching and transporting of paper files.</p>
				<h3>What is innovative in it?</h3>
				<p>Timesheet can be implemented on any type of Company or Organization either it is a Public Company or Private. It is a domain independent system <ins>(can be implemented in the Organization of any Genre)</ins>. Timesheet can handle organizations of any number of levels. Being a flexible and adaptable application the Super User <ins>(Admin)</ins> can assign any functionalities to any kind of users; according to his/her needs.</p>
