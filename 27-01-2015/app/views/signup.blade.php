...
<hr>
 ...
 {{Form::open (array('route'=>'demographics.store' , 'name'=>'Form'))}}
                <div class="top-margin">
                  <label>First Name &nbsp<span class="text-danger">*</span></label>
                ...
                <div class="top-margin">
                  <label>Last Name &nbsp<span class="text-danger">*</span></label>
                ...
                <div class="top-margin">
                  <label>Phone No. &nbsp<span class="text-danger">*</span></label>
                ...
                <div class="top-margin">
                  <label>Company</label>
                  <input name="org_name" id="org_Name" type="text" class="form-control" {{ (Input::old('org_name')) ? 'value="'. e(Input::old('org_name')) .'"' : '' }}>
                ...
                <div class="top-margin">
                  <label> Secret Question:&nbsp;&nbsp;&nbsp;&nbsp; What Is Your Mother's Birthplace?  &nbsp<span class="text-danger">*</span></label>
                ...
                <div class="top-margin">
                  <label>Email Address &nbsp<span class="text-danger">*</span></label>
               ...
               <!--  <div class="alert alert-success" role="alert">{{$errors->first('email')}}</div> -->
                ...
                <div class="row top-margin">
                  <div class="col-sm-6">
                    <label>Password &nbsp<span class="text-danger">*</span></label>
                  ...
                  <div class="col-sm-6">
                    <label>Confirm Password &nbsp<span class="text-danger">*</span></label>
